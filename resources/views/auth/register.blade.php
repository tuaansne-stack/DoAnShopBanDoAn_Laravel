            ...
            <div class="col-md-6 col-lg-5">
                ...
                <div class="auth-card">
                    <div class="auth-card-header text-center">
                        <h4 class="mb-1">Tạo tài khoản mới</h4>
                    ...
                    <div class="auth-card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="auth-input-group">
                                <label for="hoten" class="auth-label">Họ và tên <span class="text-danger">*</span></label>
                                <div class="auth-input-wrapper">
                                    <i class="fas fa-user auth-input-icon"></i>
                                    <input type="text" class="auth-input @error('hoten') is-invalid @enderror" 
                                        id="hoten" name="hoten" required
                                        value="{{ old('hoten') }}" placeholder="Nguyễn Văn A">
                                </div>
                            </div>
                            ...
                            <!-- Phone -->
                            <div class="auth-input-group">
                                <label for="sdt" class="auth-label">Số điện thoại</label>
                                <div class="auth-input-wrapper">
                                    <i class="fas fa-phone auth-input-icon"></i>
                                    <input type="tel" class="auth-input @error('sdt') is-invalid @enderror" 
                                        id="sdt" name="sdt"
                                        value="{{ old('sdt') }}" placeholder="0912 345 678">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="auth-input-group">
                                        <label for="password" class="auth-label">Mật khẩu <span class="text-danger">*</span></label>
                                        <div class="auth-input-wrapper">
                                ...
                                <div class="col-md-6">
                                    <div class="auth-input-group">
                                        <label for="password_confirmation" class="auth-label">Xác nhận <span class="text-danger">*</span></label>
                                        <div class="auth-input-wrapper">
                                            <i class="fas fa-lock auth-input-icon"></i>
                                            <input type="password" class="auth-input" 
                                                id="password_confirmation" name="password_confirmation" required
                                                placeholder="Nhập lại mật khẩu">
                                            <button type="button" class="auth-toggle-password" onclick="togglePassword('password_confirmation')">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        </div>
                                    </div>
